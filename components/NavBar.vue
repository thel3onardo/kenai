      ...
      <div class="block md:hidden pr-4 flex items-center">
        ...
        <div class="cursor-pointer" @click="mobileMenuVisible = true">
          ...
          <transition name="fade" appear>
            <div class="bg-gray-900 bg-opacity-75 w-full h-screen fixed top-0 left-0 z-10" v-if="mobileMenuVisible"> </div>
          </transition>
          <transition name="slideInLeft" appear>
            <div class="bg-gray-900 w-3/4 h-screen flex flex-col pl-5 py-8 fixed right-0 bottom-0 z-20" v-if="mobileMenuVisible">
